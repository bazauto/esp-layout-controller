---
description: "Use when performing a read-only architecture and code review using Claude Opus 4.6. Subagent only — invoked by the project-review orchestrator."
